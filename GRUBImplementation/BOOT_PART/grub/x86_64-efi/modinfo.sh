...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 15.1.1 20250425'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/15.1.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_package_version="2:2.12.r292.g73d1c959-1"
